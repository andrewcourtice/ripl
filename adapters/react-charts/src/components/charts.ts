...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<ArcDiagramChartOptions<unknown>> & RiplChartListeners<ArcDiagramChartEventMap<unknown>>, ArcDiagramChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<AreaChartOptions<unknown>> & RiplChartListeners<AreaChartEventMap>, AreaChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<BarChartOptions<unknown>> & RiplChartListeners<BarChartEventMap>, BarChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<BoxPlotChartOptions<unknown>> & RiplChartListeners<BoxPlotChartEventMap>, BoxPlotChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<ChordChartOptions> & RiplChartListeners<ChordChartEventMap>, ChordChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<ForceDirectedChartOptions<unknown>> & RiplChartListeners<ForceDirectedChartEventMap<unknown>>, ForceDirectedChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<FunnelChartOptions<unknown>> & RiplChartListeners<FunnelChartEventMap>, FunnelChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<GanttChartOptions<unknown>> & RiplChartListeners<GanttChartEventMap>, GanttChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<GaugeChartOptions> & RiplChartListeners<GaugeChartEventMap>, GaugeChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<HeatmapChartOptions<unknown>> & RiplChartListeners<HeatmapChartEventMap>, HeatmapChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<HistogramChartOptions<unknown>> & RiplChartListeners<HistogramChartEventMap>, HistogramChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<LineChartOptions<unknown>> & RiplChartListeners<LineChartEventMap>, LineChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<PackedCircleChartOptions<unknown>> & RiplChartListeners<PackedCircleChartEventMap>, PackedCircleChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<PieChartOptions<unknown>> & RiplChartListeners<PieChartEventMap>, PieChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<PolarAreaChartOptions<unknown>> & RiplChartListeners<PolarAreaChartEventMap>, PolarAreaChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<PolarScatterChartOptions<unknown>> & RiplChartListeners<PolarScatterChartEventMap>, PolarScatterChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<RadarChartOptions<unknown>> & RiplChartListeners<RadarChartEventMap>, RadarChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<RadialBarChartOptions<unknown>> & RiplChartListeners<RadialBarChartEventMap>, RadialBarChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<RealtimeChartOptions>, RealtimeChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<SankeyChartOptions<unknown>> & RiplChartListeners<SankeyChartEventMap<unknown>>, SankeyChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<ScatterChartOptions<unknown>> & RiplChartListeners<ScatterChartEventMap>, ScatterChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<StockChartOptions<unknown>> & RiplChartListeners<StockChartEventMap>, StockChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<SunburstChartOptions<unknown>> & RiplChartListeners<SunburstChartEventMap<unknown>>, SunburstChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<TreemapChartOptions<unknown>> & RiplChartListeners<TreemapChartEventMap>, TreemapChart>;
...
}) as unknown as RiplComponent<RiplHostProps & RiplChartProps<TrendChartOptions<unknown>> & RiplChartListeners<TrendChartEventMap>, TrendChart>;
