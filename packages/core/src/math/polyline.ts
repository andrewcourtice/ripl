/**
 * Polyline curve renderers: the built-in interpolation algorithms (`linear`, splines, bumps,
 * cardinal, catmull-rom, monotone, natural, steps) a polyline draws its points with, plus the
 * resolver mapping a renderer name or custom function to a concrete render function.
 */
