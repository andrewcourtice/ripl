...
/** The color residual alpha is composited against, standing in for a terminal background nothing can read. */
export const DEFAULT_BACKGROUND: [number, number, number, number] = [0, 0, 0, 1];
