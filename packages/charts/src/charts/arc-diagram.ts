...
export class ArcDiagramChart extends Chart<ArcDiagramChartOptions, ArcDiagramChartEventMap> {
    ...
    #attachNodeHover(circle: Circle, node: ArcDiagramNode, color: string) {
    ...
    #attachLinkHover(arc: Polyline, link: ArcDiagramLink, content: string, color: string) {
        const hover = this.resolveAnimation(ANIMATION_REFERENCE.hover);
