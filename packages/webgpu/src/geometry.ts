...
export class GeometryManager {
    ...
    #ensureVertexBuffer(byteSize: number): void {
    ...
    #ensureIndexBuffer(byteSize: number): void {
    ...
    #getModelBindGroup(modelMatrix: Matrix4, normalMatrix: Matrix4): GPUBindGroup {
