[Documentation](../../../packages.md) / [@ripl/charts](../index.md) / RealtimeChart

# Class: RealtimeChart

Defined in: [charts/src/charts/realtime.ts:100](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/realtime.ts#L100)

Realtime streaming chart rendering continuously updating line/area series.

Data is pushed incrementally via [RealtimeChart.push](#push) and maintained
...
- [`Chart`](Chart.md)\<[`RealtimeChartOptions`](../interfaces/RealtimeChartOptions.md)\>

## Constructors

### Constructor

> **new RealtimeChart**(`target`, `options`): `RealtimeChart`

Defined in: [charts/src/charts/realtime.ts:113](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/realtime.ts#L113)
...
| `options` | [`RealtimeChartOptions`](../interfaces/RealtimeChartOptions.md) |
...
| <a id="property-options"></a> `options` | `protected` | [`RealtimeChartOptions`](../interfaces/RealtimeChartOptions.md) | [`Chart`](Chart.md).[`options`](Chart.md#property-options) | [charts/src/core/chart.ts:69](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/core/chart.ts#L69) |
...
Defined in: [charts/src/charts/realtime.ts:208](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/realtime.ts#L208)
...
Defined in: [charts/src/charts/realtime.ts:187](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/realtime.ts#L187)
...
Defined in: [charts/src/charts/realtime.ts:383](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/realtime.ts#L383)
...
Defined in: [charts/src/charts/realtime.ts:215](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/realtime.ts#L215)
...
| Parameter | Type |
| ------ | ------ |
| `options` | `Partial`\<[`RealtimeChartOptions`](../interfaces/RealtimeChartOptions.md)\> |
