[Documentation](../../../packages.md) / [@ripl/charts](../index.md) / LineChart

# Class: LineChart\<TData\>

Defined in: [charts/src/charts/line.ts:107](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/line.ts#L107)
...
- [`Chart`](Chart.md)\<[`LineChartOptions`](../interfaces/LineChartOptions.md)\<`TData`\>\>
...
> **new LineChart**\<`TData`\>(`target`, `options`): `LineChart`\<`TData`\>

Defined in: [charts/src/charts/line.ts:119](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/line.ts#L119)
...
| <a id="property-options"></a> `options` | `protected` | [`LineChartOptions`](../interfaces/LineChartOptions.md) | [`Chart`](Chart.md).[`options`](Chart.md#property-options) | [charts/src/core/chart.ts:69](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/core/chart.ts#L69) |
...
Defined in: [charts/src/charts/line.ts:434](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/line.ts#L434)
