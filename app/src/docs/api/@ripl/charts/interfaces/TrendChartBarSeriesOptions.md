[Documentation](../../../packages.md) / [@ripl/charts](../index.md) / TrendChartBarSeriesOptions

# Interface: TrendChartBarSeriesOptions\<TData\>

Defined in: [charts/src/charts/trend.ts:90](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/trend.ts#L90)
...
| <a id="property-type"></a> `type` | `"bar"` | [`BaseTrendChartSeriesOptions`](BaseTrendChartSeriesOptions.md).[`type`](BaseTrendChartSeriesOptions.md#property-type) | - | [charts/src/charts/trend.ts:91](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/charts/src/charts/trend.ts#L91) |
