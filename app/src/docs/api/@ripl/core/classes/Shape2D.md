[Documentation](../../../packages.md) / [@ripl/core](../index.md) / Shape2D

# Class: Shape2D\<TState\>

Defined in: [packages/core/src/core/shape.ts:30](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L30)

A concrete 2D shape with path management, automatic fill/stroke rendering, clipping support, and path-based hit testing.

## Extends

- [`Shape`](Shape.md)\<`TState`\>
...
- [`Rect`](Rect.md)
- [`Ribbon`](../../charts/classes/Ribbon.md)
- [`SankeyLinkPath`](../../charts/classes/SankeyLinkPath.md)
...
> **new Shape2D**\<`TState`\>(`type`, `options`): `Shape2D`\<`TState`\>

Defined in: [packages/core/src/core/shape.ts:38](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L38)
...
| ------ | ------ |
| `type` | `string` |
| `options` | [`Shape2DOptions`](../type-aliases/Shape2DOptions.md)\<`TState`\> |
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-abstract"></a> `abstract` | `public` | `boolean` | `false` | [`Shape`](Shape.md).[`abstract`](Shape.md#property-abstract) | [packages/core/src/core/element.ts:279](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L279) |
| <a id="property-autofill"></a> `autoFill` | `public` | `boolean` | `undefined` | - | [packages/core/src/core/shape.ts:35](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L35) |
| <a id="property-autostroke"></a> `autoStroke` | `public` | `boolean` | `undefined` | - | [packages/core/src/core/shape.ts:34](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L34) |
| <a id="property-classlist"></a> `classList` | `readonly` | `Set`\<`string`\> | `undefined` | [`Shape`](Shape.md).[`classList`](Shape.md#property-classlist) | [packages/core/src/core/element.ts:277](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L277) |
| <a id="property-clip"></a> `clip` | `public` | `boolean` | `undefined` | - | [packages/core/src/core/shape.ts:36](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L36) |
| <a id="property-context"></a> `context?` | `protected` | [`Context`](Context.md)\<`Element`\> | `undefined` | [`Shape`](Shape.md).[`context`](Shape.md#property-context) | [packages/core/src/core/element.ts:273](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L273) |
| <a id="property-data"></a> `data` | `public` | `unknown` | `undefined` | [`Shape`](Shape.md).[`data`](Shape.md#property-data) | [packages/core/src/core/element.ts:282](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L282) |
| <a id="property-id"></a> `id` | `public` | `string` | `undefined` | [`Shape`](Shape.md).[`id`](Shape.md#property-id) | [packages/core/src/core/element.ts:275](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L275) |
| <a id="property-parent"></a> `parent?` | `public` | [`Group`](Group.md)\<[`ElementEventMap`](../interfaces/ElementEventMap.md)\> | `undefined` | [`Shape`](Shape.md).[`parent`](Shape.md#property-parent) | [packages/core/src/core/element.ts:281](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L281) |
| <a id="property-path"></a> `path?` | `protected` | [`ContextPath`](ContextPath.md) | `undefined` | - | [packages/core/src/core/shape.ts:32](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L32) |
| <a id="property-pointerevents"></a> `pointerEvents` | `public` | [`ElementPointerEvents`](../type-aliases/ElementPointerEvents.md) | `'all'` | [`Shape`](Shape.md).[`pointerEvents`](Shape.md#property-pointerevents) | [packages/core/src/core/element.ts:280](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L280) |
| <a id="property-state"></a> `state` | `protected` | `TState` | `undefined` | [`Shape`](Shape.md).[`state`](Shape.md#property-state) | [packages/core/src/core/element.ts:272](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L272) |
| <a id="property-type"></a> `type` | `readonly` | `string` | `undefined` | [`Shape`](Shape.md).[`type`](Shape.md#property-type) | [packages/core/src/core/element.ts:276](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L276) |
| <a id="property-defaultkey"></a> `defaultKey` | `readonly` | *typeof* [`defaultKey`](Disposer.md#property-defaultkey) | `undefined` | [`Shape`](Shape.md).[`defaultKey`](Shape.md#property-defaultkey) | [packages/core/src/core/disposer.ts:10](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/disposer.ts#L10) |
...
[`Shape`](Shape.md).[`direction`](Shape.md#direction)
...
[`Shape`](Shape.md).[`filter`](Shape.md#filter)
...
[`Shape`](Shape.md).[`font`](Shape.md#font)
...
[`Shape`](Shape.md).[`globalCompositeOperation`](Shape.md#globalcompositeoperation)
...
[`Shape`](Shape.md).[`lineCap`](Shape.md#linecap)
...
[`Shape`](Shape.md).[`lineDash`](Shape.md#linedash)
...
[`Shape`](Shape.md).[`lineDashOffset`](Shape.md#linedashoffset)
...
[`Shape`](Shape.md).[`lineJoin`](Shape.md#linejoin)
...
[`Shape`](Shape.md).[`lineWidth`](Shape.md#linewidth)
...
[`Shape`](Shape.md).[`miterLimit`](Shape.md#miterlimit)
...
[`Shape`](Shape.md).[`rotation`](Shape.md#rotation)
...
[`Shape`](Shape.md).[`shadowBlur`](Shape.md#shadowblur)
...
[`Shape`](Shape.md).[`shadowColor`](Shape.md#shadowcolor)
...
[`Shape`](Shape.md).[`shadowOffsetX`](Shape.md#shadowoffsetx)
...
[`Shape`](Shape.md).[`shadowOffsetY`](Shape.md#shadowoffsety)
...
[`Shape`](Shape.md).[`textAlign`](Shape.md#textalign)
...
[`Shape`](Shape.md).[`textBaseline`](Shape.md#textbaseline)
...
[`Shape`](Shape.md).[`transformOriginX`](Shape.md#transformoriginx)
...
[`Shape`](Shape.md).[`transformOriginY`](Shape.md#transformoriginy)
...
[`Shape`](Shape.md).[`transformScaleX`](Shape.md#transformscalex)
...
[`Shape`](Shape.md).[`transformScaleY`](Shape.md#transformscaley)
...
[`Shape`](Shape.md).[`destroy`](Shape.md#destroy)
...
[`Shape`](Shape.md).[`dispose`](Shape.md#dispose)
...
[`Shape`](Shape.md).[`emit`](Shape.md#emit)
...
[`Shape`](Shape.md).[`getBoundingBox`](Shape.md#getboundingbox)
...
[`Shape`](Shape.md).[`getStateValue`](Shape.md#getstatevalue)
...
[`Shape`](Shape.md).[`has`](Shape.md#has)
...
[`Shape`](Shape.md).[`interpolate`](Shape.md#interpolate)
...
[`Shape`](Shape.md).[`intersectsWith`](Shape.md#intersectswith)
...
[`Shape`](Shape.md).[`off`](Shape.md#off)
...
[`Shape`](Shape.md).[`once`](Shape.md#once)

***

### render()

> **render**(`context`, `callback?`): `void`

Defined in: [packages/core/src/core/shape.ts:88](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/shape.ts#L88)
...
[`Shape`](Shape.md).[`retain`](Shape.md#retain)
...
[`Shape`](Shape.md).[`setStateValue`](Shape.md#setstatevalue)
