[Documentation](../../../packages.md) / [@ripl/core](../index.md) / Task

# Class: Task\<TResult\>

Defined in: [packages/core/src/task/index.ts:38](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/task/index.ts#L38)
...
| Parameter | Type |
| ------ | ------ |
| `executor` | [`TaskExecutor`](../type-aliases/TaskExecutor.md)\<`TResult`\> |
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-tostringtag"></a> `[toStringTag]` | `readonly` | `string` | [`Transition`](Transition.md).[`[toStringTag]`](Transition.md#property-tostringtag) | node\_modules/typescript/lib/lib.es2015.symbol.wellknown.d.ts:176 |
| <a id="property-species"></a> `[species]` | `readonly` | `PromiseConstructor` | `Promise.[species]` | node\_modules/typescript/lib/lib.es2015.symbol.wellknown.d.ts:180 |
