[Documentation](../../../packages.md) / [@ripl/core](../index.md) / Element

# Class: Element\<TState, TEventMap\>

Defined in: [packages/core/src/core/element.ts:267](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L267)

The base renderable element with state management, event handling, interpolation, transform support, and context rendering.

## Extends

- [`EventBus`](EventBus.md)\<`TEventMap`\>
...
> **new Element**\<`TState`, `TEventMap`\>(`type`, `__namedParameters`): `Element`\<`TState`, `TEventMap`\>

Defined in: [packages/core/src/core/element.ts:502](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L502)
...
| ------ | ------ |
| `type` | `string` |
| `__namedParameters` | [`ElementOptions`](../type-aliases/ElementOptions.md)\<`TState`\> |

#### Returns

`Element`\<`TState`, `TEventMap`\>
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-abstract"></a> `abstract` | `public` | `boolean` | `false` | - | - | [packages/core/src/core/element.ts:279](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L279) |
| <a id="property-classlist"></a> `classList` | `readonly` | `Set`\<`string`\> | `undefined` | - | - | [packages/core/src/core/element.ts:277](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L277) |
| <a id="property-context"></a> `context?` | `protected` | [`Context`](Context.md)\<`Element`\> | `undefined` | - | - | [packages/core/src/core/element.ts:273](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L273) |
| <a id="property-data"></a> `data` | `public` | `unknown` | `undefined` | - | - | [packages/core/src/core/element.ts:282](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L282) |
| <a id="property-id"></a> `id` | `public` | `string` | `undefined` | - | - | [packages/core/src/core/element.ts:275](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L275) |
| <a id="property-parent"></a> `parent?` | `public` | [`Group`](Group.md)\<`TEventMap`\> | `undefined` | [`EventBus`](EventBus.md).[`parent`](EventBus.md#property-parent) | - | [packages/core/src/core/element.ts:281](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L281) |
| <a id="property-pointerevents"></a> `pointerEvents` | `public` | [`ElementPointerEvents`](../type-aliases/ElementPointerEvents.md) | `'all'` | - | - | [packages/core/src/core/element.ts:280](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L280) |
| <a id="property-state"></a> `state` | `protected` | `TState` | `undefined` | - | - | [packages/core/src/core/element.ts:272](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L272) |
| <a id="property-type"></a> `type` | `readonly` | `string` | `undefined` | - | - | [packages/core/src/core/element.ts:276](https://github.com/andrewcourtice/ripl/blob/bc5e0c58d332ae38e6a8809ca70cac73c20fa408/packages/core/src/core/element.ts#L276) |
...
> **clone**(): `Element`\<`TState`, [`ElementEventMap`](../interfaces/ElementEventMap.md)\>
...
`Element`\<`TState`, [`ElementEventMap`](../interfaces/ElementEventMap.md)\>
