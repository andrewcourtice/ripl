...
export default defineConfig({
    resolve: {
        alias: {
            ...
            '@ripl/adapters': resolve('adapters'),
            '@ripl/adapters-3d': resolve('adapters-3d'),
            '@ripl/adapters-charts': resolve('adapters-charts'),
            '@ripl/vue': resolveAdapter('vue'),
            '@ripl/vue-3d': resolveAdapter('vue-3d'),
            '@ripl/vue-charts': resolveAdapter('vue-charts'),
            '@ripl/react': resolveAdapter('react'),
            '@ripl/react-3d': resolveAdapter('react-3d'),
            '@ripl/react-charts': resolveAdapter('react-charts'),
        },
    },
    test: {
        watch: false,
